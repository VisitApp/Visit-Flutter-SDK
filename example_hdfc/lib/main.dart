...
void main() => runApp(const HdfcCompatibilityApp());

class HdfcCompatibilityApp extends StatelessWidget {
  const HdfcCompatibilityApp({super.key});
...
class _UrlInputScreenState extends State<UrlInputScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('HDFC SDK Compatibility')),
      body: Padding(
